...
namespace FoodRocket.Services.Identity.Infrastructure.Decorators;
    ...
    where TCommand : class, ICommand
{
    ...
    public Task HandleAsync(TCommand command, CancellationToken cancellationToken = new CancellationToken()) => _enabled
